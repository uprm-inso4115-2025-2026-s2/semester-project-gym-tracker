...
The rough sketch described concrete experiences (“I can’t remember what I did last week”). The terminology abstracts these into structured, repeatable domain concepts, ensuring that informal observations are consistently represented at the domain level.
...
The raw metaphor (“Duolingo-like”) was replaced with precise definitions that remove application-specific language and resolve ambiguity, focusing instead on observable domain phenomena such as consecutive attendance and behavioral patterns.
