...
* #*Exercise* - a structured unit of activity performed within a workout.#
...
#The terminology therefore reflects more than generic memory difficulty. It captures a bounded workout occurrence, its internal components, and the distinction between day-level attendance and session-level content.#

====== (2) “Consistency and streaks as different ideas”

#The strengthened elicitation statements distinguished between regular activity over time and uninterrupted consecutive activity. Participants described feeling “on track” when they had several active days in a week even if those days were not consecutive, while also describing streaks as a more specific motivational pattern. From this, we formalized:#

* *Streak* - a sequence of consecutive attendance days.
* *Missed Day* - a calendar day without a workout despite expectation.
* #*Consistency* - regularity of workout activity across a Time Frame, not necessarily consecutive.#

#This distinction is important because it prevents the terminology from treating consistency and streak as interchangeable. A streak is one specific pattern of regularity, while consistency is the broader behavioral idea.#
...
* *Goal* - #a desired level of activity within a defined Time Frame.#
* *Weekly Activity Pattern* - #distribution of workout-related events across the Calendar Days of a Week.#
* *Goal period has just ended* #(Domain Concept, Category: Event).#
* *evaluateGoal(...) and summarizeWeek(...)* #(Domain Concepts, Category: Action).#
