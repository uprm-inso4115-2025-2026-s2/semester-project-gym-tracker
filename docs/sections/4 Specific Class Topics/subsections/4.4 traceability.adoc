...
- #Acquisition artifacts/evidence: AQ1, AQ2, ... (from Section 4.3 questionnaires, interviews, and source reviews)#
- #Elicitation findings/resolution items: FE1..FEn, RT1..RTn (from Section 2.2.3 inconsistency cases and resolutions)#
...
#The new acquisition material in Section 4.3 is traceable so the reader can see that the questionnaire is not just included as an appendix artifact; it informs concrete requirements and later elicitation decisions.#

[cols="1,3,4",options="header"]
|===
|#Acquisition artifact# |#What it contributes# |#Linked requirements / elicitation decisions#

|#AQ1 - Gym-user questionnaire#
|#Collects stakeholder evidence about logging friction, correction behavior, weekly goal interpretation, desired summaries, validation expectations, and account needs.#
|#Low-Effort Logging; Essential Information Recording; Separation of Nutrition Tracking; Persistent Storage and Retrieval; Goal Evaluation; Performance Summary Representation; Data Validation Rules; Recording Real-World Workouts; Editing and Correction of Workout Data; Viewing Progress and History; FE-1; FE-2; FE-3.#

|#AQ2 - Stakeholder micro-interviews#
|#Provides scenario detail and terminology that require follow-up clarification during elicitation.#
|#RT-1; RT-2; RT-3 and any future scenario-based refinements to requirements in Section 2.2.3.#

|#AQ3 - Competitive feature review#
|#Provides comparison points for minimum logging fields, summary patterns, and known friction sources from existing fitness tools.#
|#Low-Effort Logging; Performance Summary Representation; user account management acquisition in LTT266.#
|===

==== 4.4.4 How We Will Maintain Traceability

- Each requirement section will include a short “Supports: {G*, N*, Persona}” line.
- #Each acquisition artifact in Section 4.3 will keep its own ID (for example AQ1) so later changes can reference the evidence source separately from the elicitation decision derived from it.#
