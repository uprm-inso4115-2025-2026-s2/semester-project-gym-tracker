...
|[.added]#I-3#
|[.changed]#Interface requirements (Section 2.2.4) — 5 requirements: GymGoer Account Setup, Recording Real-World Workouts, Editing and Correction of Workout Data (interface side), Goal Initialization and Update, Viewing Progress and History#
|===
